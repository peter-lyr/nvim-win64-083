...
local sta, packadd = pcall(c, 'packadd diffview.nvim')
if not sta then
  print(packadd)
  return nil
end
...
local actions
sta, actions = pcall(require, "diffview.actions")
if not sta then
  print(actions)
  return
end
...
local diffview
sta, diffview = pcall(require, "diffview")
if not sta then
  print(diffview)
  return
end

g.diffview_max_count = 8
  ...
  return {
      ...
      log_options = {
        ...
        git = {
          single_file = {
            ...
            max_count = g.diffview_max_count,
          },
          multi_file = {
    ...
    keymaps = {
      ...
      file_history_panel = {
        ...
        { "n", "D",             actions.open_in_diffview,           { desc =
...
M.toggle_history_cnt = function()
  if g.diffview_max_count == 32768 then
    g.diffview_max_count = 8
    require("diffview").setup(get_table())
  else
    g.diffview_max_count = 32768
    require("diffview").setup(get_table())
  end
  print('g:diffview_max_count:', g.diffview_max_count)
end
